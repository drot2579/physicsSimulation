...
class Cube {
    mass = 1
    forces = []
    totalForce = new Vector("totalForce", [0, 0])
    acceleration = new Vector("acceleration", [0, 0])
    velocity = new Vector("velocity", [0, 0])
    size = new Vector("size", [20, 20])
    ...
    brake() {
        this.velocity.y = this.velocity.x = this.acceleration.x = this.acceleration.y = 0
    }
    balance() {
    ...
    updatePhys() {
        ...
        /* ----------  -------- ---------- ---------- ----------*/
        this.velocity.x += this.acceleration.x / anim.frame.rate
        this.velocity.y += this.acceleration.y / anim.frame.rate
